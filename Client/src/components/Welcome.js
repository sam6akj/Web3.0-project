...
const handleSubmit=(e)=>{
  ...
  return (
    <div className='flex w-full jusitfy-center items-center'>
        <div className='flex md:flex-row flex-col items-start justify-between md:p-20 py-12 px-4'>
            <div className='flex flex-1 justify-start flex-col md:mr-10'>
                ...
                <p className='text-left mt-5 text-white font-light md:w-9/12 w-11/12 text-base'>
                    Explore the crypto world.Buy and Sell crypto currencies easily on Aethereo
                </p>
                {! connectedAccount &&<button
                 type='button'
                 onClick={connectWallet}  
                 className='flex flex-row justify-center items-center my-5 bg-[#40DFEF] p-3 rounded-full cursor-pointer hover:bg-[#0e95a4]'               >
                ...
                <div className='grid sm:grid-cols-3 grid-cols-2 w-full mt-10'>
                    ...
                    <div className={commonStyles}>Scalable</div>
        ...
        <div className='flex flex-col flex-1 items-center justify-center w-full md:mt-0 mt-10'>
            ...
            <div className='p-5 sm:w-96 w-full flex flex-col justify-start items-center blue-glassmorphism'> 
                ...
                {false? (
                    ...
                    className='text-white w-full mt-2 border-[1px] p-2 border-[#3d4f7c] rounded-full cursor-pointer hover:bg-[#0B1C55]'> 
                        Send Now
                    </button>
                )}
            </div>
