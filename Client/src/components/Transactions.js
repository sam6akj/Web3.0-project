        ...
        '>
            <div className='flex flex-col items-center w-full mt-3'>
                <div className=' w-full mb-6 p-2 '>
                    <a href={`https://rinkeby.etherscan.io/address/${addressFrom}`} target='blank' rel='noopenor noreferrer'>
                    <p className='text-white text-base'>From: {shortenAddress(addressFrom)}</p></a>
                    <a href={`https://rinkeby.etherscan.io/address/${addressTo}`} target='blank' rel='noopenor noreferrer'>
                    ...
                    <div className='bg-black p-3 px-5 w-max my-4 rounded-3xl -mt-5 shadow-2xl '>
